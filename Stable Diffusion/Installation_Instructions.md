...
4. We go to the above link and copy the url. We open a **cmd** and run the following command: git clone  https://github.com/AUTOMATIC1111/stable-diffusion-webui .
